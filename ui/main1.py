...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_action_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_action_4.setGeometry(QtCore.QRect(760, 110, 181, 28))
        self.pushButton_action_4.setObjectName("pushButton_action_4")
        ...
        self.pushButton_action_5.setGeometry(QtCore.QRect(760, 140, 181, 28))
        ...
        self.pushButton_action_1.setGeometry(QtCore.QRect(570, 110, 181, 28))
        ...
        self.pushButton_action_2.setGeometry(QtCore.QRect(570, 140, 181, 28))
        ...
        self.label.setGeometry(QtCore.QRect(570, 220, 171, 21))
        self.label.setObjectName("label")
        self.pushButton_action_last = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_action_last.setGeometry(QtCore.QRect(570, 240, 181, 28))
        ...
        self.pushButton_action_6.setGeometry(QtCore.QRect(760, 170, 181, 28))
        self.pushButton_action_6.setObjectName("pushButton_action_6")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(570, 200, 501, 21))
        ...
        self.pushButton_action_3.setGeometry(QtCore.QRect(570, 170, 181, 28))
        ...
        self.pushButton_remember_setting.setGeometry(QtCore.QRect(820, 30, 111, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_action_4.setText(_translate("MainWindow", "参考文献.多行格式化(4)"))
        self.pushButton_left1.setText(_translate("MainWindow", "粘贴"))
        self.pushButton_left2.setText(_translate("MainWindow", "复制"))
        self.pushButton_action_5.setText(_translate("MainWindow", "摘要.按分号分隔(5)"))
        self.pushButton_action_1.setText(_translate("MainWindow", "合并行(1)"))
        self.pushButton_action_2.setText(_translate("MainWindow", "合并行后按点分隔(2)"))
        ...
        self.pushButton_action_6.setText(_translate("MainWindow", "无处理(6)"))
        self.label_7.setText(_translate("MainWindow", "==================================================================="))
        self.label_8.setText(_translate("MainWindow", "处理框1内容后输出到框2"))
        self.pushButton_left3.setText(_translate("MainWindow", "复制"))
        self.pushButton_action_3.setText(_translate("MainWindow", "去除连续空格(3)"))
